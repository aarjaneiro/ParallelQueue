"""
The "ParallelQueue" project is currently in its early stages of development.
...
Note
----
The GitHub master build can be (and likely is) different from the PyPi build, being more up-to-date.
...
version (e.g., for code stability as it is updated less-frequently).
"""
